...
public class frmDeliverTackStep1 extends javax.swing.JPanel {
    ...
    void VoiceTip() {
        CCommondFunc.VoiceTip("Please scan or enter the package bar code to fetch the package.");
    }
    ...
    public void TTkeyBoardInput(CBaseEnum.KeyType eKeyType, String strInput) {
        ...
        FuncClass.CBaseTime.ReSetTime();// Re timing
        ...
        switch (eKeyType) {
            case Key_BarCode:
                ...
                if (txtOrderID_Validated()) {
                    NextStep();// Verify that the next step is invoked automatically
                }
                break;
            case Key_NUMBER:
                if (!"".equals(strInput)) {
            ...
            case Key_ENTER:
                if (txtOrderID.GetText().length() > 1) {
                    ...
                    lblTipMsg.setText("The package number should not be empty!");
                }
                break;
            case Key_ESC:
    ...
    private void initComponents() {
        ...
        lblTitle.setFont(new java.awt.Font("Microsoft YaHei", 0, 36)); // NOI18N
        lblTitle.setForeground(new java.awt.Color(255, 255, 255));
        lblTitle.setText("Remove the package");
        ...
        lblTimeOut1.setFont(new java.awt.Font("Microsoft YaHei", 0, 18)); // NOI18N
        lblTimeOut1.setForeground(new java.awt.Color(255, 255, 255));
        lblTimeOut1.setText("Execution interface is left");

        lblSeconds.setBackground(new java.awt.Color(6, 57, 104));
        lblSeconds.setFont(new java.awt.Font("Microsoft YaHei", 0, 18)); // NOI18N
        ...
        lblTimeOut2.setFont(new java.awt.Font("Microsoft YaHei", 0, 18)); // NOI18N
        lblTimeOut2.setForeground(new java.awt.Color(255, 255, 255));
        lblTimeOut2.setText("In seconds, the quit operation returns to the home page");
        ...
        lblTitle1.setFont(new java.awt.Font("Microsoft YaHei", 0, 36)); // NOI18N
        lblTitle1.setForeground(new java.awt.Color(255, 255, 255));
        lblTitle1.setText("Package Bar Code:");

        btnBatchTack.setFont(new java.awt.Font("Microsoft YaHei", 1, 18)); // NOI18N
        btnBatchTack.setText("Batch picking");
        ...
        lblTipMsg.setFont(new java.awt.Font("Blackbody", 0, 24)); // NOI18N
    ...
    boolean txtOrderID_Validated() {
        ...
        if (!ret) {
            lblTipMsg.setText("The package number information does not exist, please re-enter!");
            return false;
        }
        
        // Update table tb_Order, late pick-up mode fi_PickUpFlag = 2; BGetA
    ...
    void NextStep() {
        ...
        if (null != property) {
            CLogicHandle.OpenBox(property, CBaseEnum.Lock_DispRevokeOpen, CDataMgr.TDYPhone, CBaseEnum.Action_TDYQJ, "Deliverer's single pick-up door");
        }
    }
